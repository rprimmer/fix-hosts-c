...
void usage(char *program) {
    ...
    printf("  -a       Add a DNS entry to allow list and remove from /etc/hosts\n\n");
    printf("Actions:\n");
...
int main(int argc, char **argv) {
    ...
    while (getopt(argc, argv, "fha") != -1) {
        ...
        case 'a':
            ...
            if (!DNS_NAME)
                handleError("Invalid argument for -a switch");
            printf("DNS Add\n");
    ...
    if (optind < argc) {
        handleError("no arguments provided");
    }
