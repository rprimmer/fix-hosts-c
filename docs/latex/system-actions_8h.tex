...
\begin{DoxyCompactList}\small\item\em Make a copy of a file. Uses libC functions. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Make a copy of a file. Uses system calls. \end{DoxyCompactList}\item 
...
int \mbox{\hyperlink{system-actions_8h_a954cf5c78ab5efeeac25286821eb6177}{check\+Process}} (const char \texorpdfstring{$\ast$}{*}process\+\_\+name, bool display\+\_\+pids)
...
\end{DoxyReturn}
\Hypertarget{system-actions_8h_a954cf5c78ab5efeeac25286821eb6177}\label{system-actions_8h_a954cf5c78ab5efeeac25286821eb6177} 
...
{\footnotesize\ttfamily int check\+Process (\begin{DoxyParamCaption}\item[{const char \texorpdfstring{$\ast$}{*}}]{process\+\_\+name,  }\item[{bool}]{display\+\_\+pids }\end{DoxyParamCaption})}
...
\hline
{\em display\+\_\+pids} & Optionally display PIDs of running process. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
int Return status. 
...
Make a copy of a file. Uses libC functions. 
...
Make a copy of a file. Uses system calls. 
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
int Return true if file exists. 
\end{DoxyReturn}
